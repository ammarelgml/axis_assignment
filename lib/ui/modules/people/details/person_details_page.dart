    ...
    return Scaffold(
      body: Stack(
        children: [
          RefreshIndicator(
            onRefresh: () async {
              personImageBloc.add(GetPersonImages(widget.people.id));
            },
            child: CustomScrollView(
              slivers: [
                ...
                SliverAppBar(
                  elevation: 4,
                  expandedHeight: screenAwareHeight(190, context),
                  collapsedHeight: screenAwareHeight(190, context),
                  toolbarHeight: screenAwareHeight(190, context),
                  floating: false,
                  pinned: true,
                  snap: false,
                  stretch: true,
                                          ...
                                          (image) => GestureDetector(
                                            onTap: () {
                                              Navigator.of(context)
                                                  .pushNamed(RouteNames.rImagePreviewPage, arguments: image);
                                            },
                                            child: Hero(
                                              tag: image.filePath,
